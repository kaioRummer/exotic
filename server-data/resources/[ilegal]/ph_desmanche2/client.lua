...
emP = Tunnel.getInterface("ph_desmanche2")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local locais = { 
	 { ['x'] = 1535.63, ['y'] = 3547.81, ['z'] = 36.96, ['perm'] = "motoclub.permissao" }, -- 1535.15, 3547.06, 36.28
	 { ['x'] = 986.28, ['y'] = -139.0, ['z'] = 73.1, ['perm'] = "driftking.permissao" } -- 906.68, -2100.72, 30.78
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- DESMANCHE
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	while true do
		...
		if roubando then
			...
			elseif segundos > 19 and segundos < 33 then
				sleep = 4
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Frente Direita.")
				SetVehicleDoorOpen(veh,0,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Frente Esquerda.")	
				SetVehicleDoorOpen(veh,1,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Traseira Direita.")	
				SetVehicleDoorOpen(veh,2,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Traseira Esquerda.")	
				SetVehicleDoorOpen(veh,3,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo o Capo.")	
				SetVehicleDoorOpen(veh,4,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo o o Porta Mala.")	
			...
			elseif segundos <= 16 and segundos >= 4 then
				...
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Importante","Veiculo desmontado.")
				TriggerEvent("Notify","importante","Importante","Dinheiro recebido.")
			end
		end
		Citizen.Wait(sleep)
	end
