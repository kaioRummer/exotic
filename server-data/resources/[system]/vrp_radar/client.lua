...
local radares = {
    ["radar01"] = {
        position = { ["x"] = 157.50942993164, ["y"] = -1021.6500244141, ["z"] = 39.243404388428, ["colour"] = 1, ["id"] = 161, ["title"] = "Radar 100KM/H", ["maxvel"] = 100 } -- 203.0986328125,-1031.9599609375,35.295879364014
    },
    ["radar02"] = {
    ...
    ["radar05"] = {
        position = { ["x"] = 1432.7321777344, ["y"] = 715.87158203125, ["z"] = 87.875534057617, ["colour"] = 1, ["id"] = 161, ["title"] = "Radar 40KM/H", ["maxvel"] = 40 } -- 1432.7321777344,715.87158203125,87.875534057617
    },
    ["radar06"] = {
            ...
            if distance < 30 and vel > v.position.maxvel then
                if not funch.checkcop("policia.permissao") then
                    if not funch.checkcop("rota.permissao") then
                        if not funch.checkcop("samu.permissao") then
                            if not funch.checkcop("cet.permissao") then
