...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookjoins = "https://canary.discord.com/api/webhooks/879708276290363393/cRZ66Rv6rnInoCmGZpRKFIDuIDjodNkpelMw7u0fDGbBzRSi4QGhxlHeeVkcQiOLij46"
local webhookexit = "https://canary.discord.com/api/webhooks/879708391767961700/tXls4Dv4isAs8wE7P7UCx5rhG-gmOzJ5Po7x7fjkJ_0iT9ryJ9ab_UZbX_1wOPdeUaSb"
...
vRP.prepare("vRP/create_user","INSERT INTO vrp_users(last_login,ip,whitelisted,banned) VALUES('','',false,false); SELECT LAST_INSERT_ID() AS id")
		...
		if user_id then
			...
			if not vRP.isBanned(user_id) then
				...
				if vRP.isWhitelisted(user_id) then
					...
					deferrals.done("Você não tem um passaporte na cidade, entre em nosso discord https://discord.gg/FCK85pKCPU e mande seu ID: "..user_id) 
					TriggerEvent("queue:playerConnectingRemoveQueues",ids)
				end
			else
				deferrals.done("Seu passaporte foi revogado. ID:"..user_id)
				TriggerEvent("queue:playerConnectingRemoveQueues",ids)
			end
		else
