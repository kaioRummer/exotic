...
Config.Priority = {
	-- Lista de Pioridade deve seguir o padrao abaixo! 
	--["steam:numeroaletorio"] = 100,
	--["steam:numeroaletorio"] = 20
}
...
Config.Language = {
	joining = "[ CidadeRPClean ]Entrando...",
	connecting = "[ CidadeRPClean ]Conectando...",
	err = "[ CidadeRPClean ]Não foi possível identificar sua Steam ou Social Club.",
	_err = "[ CidadeRPClean ]Você foi desconectado por demorar demais na fila.",
	pos = "[ CidadeRPClean ]Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[ CidadeRPClean ]Não foi possível adiciona-lo na fila.",
    wlonly = "[ CidadeRPClean ]Você não está aprovado na whitelist.",
	banned = "[ CidadeRPClean ] Seu passaporte foi revogado na cidade, OTARIO 2 bjs",
	steam = "[ CidadeRPClean ]Você precisa estar com a Steam aberta para conectar."
}
