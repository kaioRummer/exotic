...
AddEventHandler("vRP:playerJoin",function(user_id,source,name)
	vRP.execute("vRP/money_init_user",{ user_id = user_id, wallet = 5000, bank = 55000 })
	local tmp = vRP.getUserTmpTable(user_id)
	if tmp then
...
function vRP.hasPermission(user_id, permissao)
	return vRP.terPemissao(user_id,permissao)
 end