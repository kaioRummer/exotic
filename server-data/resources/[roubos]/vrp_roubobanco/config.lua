...
Config.SafeMinimum = 40000
Config.SafeMax = 60000

Config.SafeMinimumCarrinho = 30000
Config.SafeMaxCarrinho = 40000
...
Config.BankRobbery = {
    [1] = {
        ...
        Cops = 0, -- QUANTOS POLICIAIS ONLINE
        Doors = { 
            ...
            {Coords = vector3(252.95, 221.16, 101.68), Object = "hei_v_ilev_bk_safegate_pris", Heading = 160.0, WeldPosition = {C = vector3(253.53,221.00,100.68), H = 288.79}, Time = 2, Frozen = true}, 
            {Coords = vector3(261.36, 215.67, 101.68), Object = "hei_v_ilev_bk_safegate_pris", Heading = -110.0, WeldPosition = {C = vector3(261.25, 216.03, 100.68), H = 55.62}, Time = 2, Frozen = true},
