		...
		if #policia >= 3 then
			if timers[id] == 0 or not timers[id] then
					...
					for l,w in pairs(policia) do
						...
						if player then
							async(function()
								...
								TriggerClientEvent("NotifyPush",player,{ code = 31, title = "O roubo começou na Registradora, dirija-se até o local e intercepte os assaltantes.", x = x, y = y, z = z, badge = "Registradora." })
				...
				SetTimeout(1000,function()
					vRP.giveInventoryItem(user_id,"dinheirosujo",math.random(900,1500))
				end)
			else
