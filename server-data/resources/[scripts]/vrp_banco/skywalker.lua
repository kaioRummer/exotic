...
local webhookSacar = "https://discord.com/api/webhooks/752209192651325491/8gOPobuwgv7xnn3jpgrjes5t-4x6O8itCASh8xaV43luZ_mkr1AtdCHd_FLwTCFtcmup"
local webhookPTrans = ""
local webhookPSacar = ""
local webhookRCaixaEletronico = "https://discord.com/api/webhooks/752194256449306754/6tQUBbGCgD3W2rciVDDfn1lN-_cx-RWGIPdO7Qrol84Fjcv97iJKB2bKzRZDXp3NEx96"
...
function banK.checkRobbery(id,x,y,z,head)
	...
	if user_id then
		if #policia <= 2 then
			TriggerClientEvent("Notify",source,"aviso","Número insuficiente de policiais em patrulha no momento min 2 Policiais.",8000)
		else
