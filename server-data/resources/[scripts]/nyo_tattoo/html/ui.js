                        ...
                        let price = tattooShop[atualPart].tattoo[i].price;
                            $("footer").append(`
                                <div class="item-tattoo" data-partname="${partName}" data-partid="${i}" data-parttype="${atualPart}" onclick="select(this)" id="${atualPart}${i}">
                                    <div class="img-tattoo" style="background-image: url('http://127.0.0.1/tattoo/${atualPart}/${dlcName}/${partName}.jpg')">  
                                        <div class="overlay">
        ...
        if (tattooShop[atualPart].active){
            for (var i = 0; i <= (tattooShop[atualPart].tattoo.length - 1); i++) {
                ...
                let price = tattooShop[atualPart].tattoo[i].price;
                    $("footer").append(`
                        <div class="item-tattoo" data-partname="${partName}" data-partid="${i}" data-parttype="${atualPart}" onclick="select(this)" id="${atualPart}${i}">
                            <div class="img-tattoo" style="background-image: url('http://191.96.78.137/tattoos/${atualPart}/${dlcName}/${partName}.jpg')">  
                                <div class="overlay">
