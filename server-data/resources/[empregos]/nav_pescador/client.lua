...
local TeleportFromTo = {
	["texto_localonibus"] = {
		positionFrom = { ['x'] = -2176.18, ['y'] = -460.89, ['z'] = 1.83, nom = "~b~Tenha uma ~y~isca~y~ ~b~ em mãos para pescar!!"},  
		positionTo = {  ['x'] = -1816.57, ['y'] = -1193.71, ['z'] = 14.31,nom = "~b~Pressione ~y~E~y~ ~b~para vender sua pesca"},
	},
}
